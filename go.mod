...
replace github.com/rancher/norman => github.com/aiwantaozi/norman v0.0.2

require (
	github.com/pkg/errors v0.8.0
	github.com/rancher/norman v0.0.0-20180925184916-d675dc79491f
	github.com/sirupsen/logrus v1.0.4-0.20170822132746-89742aefa4b2
	k8s.io/api v0.0.0-20180621150657-6c0bbc3e58fa+incompatible
	k8s.io/apiextensions-apiserver v0.0.0-20180621165922-80db67131e8d
	k8s.io/apimachinery v0.0.0-20180619225948-e386b2658ed2+incompatible
