...
type ProjectAlertPolicyHandlerFunc func(key string, obj *ProjectAlertPolicy) (runtime.Object, error)
...
type ProjectAlertPolicyController interface {
	...
	AddHandler(ctx context.Context, name string, handler ProjectAlertPolicyHandlerFunc)
	AddClusterScopedHandler(ctx context.Context, name, clusterName string, handler ProjectAlertPolicyHandlerFunc)
...
type ProjectAlertPolicyInterface interface {
	...
	AddHandler(ctx context.Context, name string, sync ProjectAlertPolicyHandlerFunc)
	AddLifecycle(ctx context.Context, name string, lifecycle ProjectAlertPolicyLifecycle)
	AddClusterScopedHandler(ctx context.Context, name, clusterName string, sync ProjectAlertPolicyHandlerFunc)
	AddClusterScopedLifecycle(ctx context.Context, name, clusterName string, lifecycle ProjectAlertPolicyLifecycle)
}
...
func (c *projectAlertPolicyController) AddHandler(ctx context.Context, name string, handler ProjectAlertPolicyHandlerFunc) {
	c.GenericController.AddHandler(ctx, name, func(key string, obj interface{}) (interface{}, error) {
		if obj == nil {
			return handler(key, nil)
		} else if v, ok := obj.(*ProjectAlertPolicy); ok {
...
func (c *projectAlertPolicyController) AddClusterScopedHandler(ctx context.Context, name, cluster string, handler ProjectAlertPolicyHandlerFunc) {
	c.GenericController.AddHandler(ctx, name, func(key string, obj interface{}) (interface{}, error) {
		if obj == nil {
			return handler(key, nil)
		} else if v, ok := obj.(*ProjectAlertPolicy); ok && controller.ObjectInCluster(cluster, obj) {
			return handler(key, v)
		} else {
			return nil, nil
		}
...
func (s *projectAlertPolicyClient) AddHandler(ctx context.Context, name string, sync ProjectAlertPolicyHandlerFunc) {
	s.Controller().AddHandler(ctx, name, sync)
}

func (s *projectAlertPolicyClient) AddLifecycle(ctx context.Context, name string, lifecycle ProjectAlertPolicyLifecycle) {
	sync := NewProjectAlertPolicyLifecycleAdapter(name, false, s, lifecycle)
	s.Controller().AddHandler(ctx, name, sync)
}

func (s *projectAlertPolicyClient) AddClusterScopedHandler(ctx context.Context, name, clusterName string, sync ProjectAlertPolicyHandlerFunc) {
	s.Controller().AddClusterScopedHandler(ctx, name, clusterName, sync)
}

func (s *projectAlertPolicyClient) AddClusterScopedLifecycle(ctx context.Context, name, clusterName string, lifecycle ProjectAlertPolicyLifecycle) {
