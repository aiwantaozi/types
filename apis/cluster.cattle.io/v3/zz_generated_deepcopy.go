...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CommonGraphSpec) DeepCopyInto(out *CommonGraphSpec) {
	*out = *in
	if in.MonitorGraphSelector != nil {
		in, out := &in.MonitorGraphSelector, &out.MonitorGraphSelector
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CommonGraphSpec.
func (in *CommonGraphSpec) DeepCopy() *CommonGraphSpec {
	if in == nil {
		return nil
	}
	out := new(CommonGraphSpec)
	in.DeepCopyInto(out)
	return out
}
